...
public class TableComparator implements Comparator<TableItem> {
    ...
    public int compare(TableItem left, TableItem right) {
        ...
        switch (mSortColumn) {
            ...
            case BODY:
                return sortInt(left.getBean().getScoreBody(), right.getBean().getScoreBody());
            case COCK:
                return sortInt(left.getBean().getScoreCock(), right.getBean().getScoreCock());
            case ASS:
                return sortInt(left.getBean().getScoreAss(), right.getBean().getScoreAss());
            case CUM:
